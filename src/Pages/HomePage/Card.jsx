            ...
            <div className="card group max-w-[460px] card-compact bg-base-100 shadow-xl">
                ...
                <div className="card-body">
                    ...
                    <div className="card-actions relative justify-between">
                        ...
                        <div>
                            <Link to={`/scholarship-details/${id}`} className='max-w-max max-h-max'>   <button className="btn -translate-x-5 transition-all duration-300 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 hover:bg-[#7CFF77] hover:text-[#14452F] bg-[#185137] text-white font-">Enroll Now</button></Link>
